...
import classes from './ProfileRightBox.module.css';
...
const profileRightBox = (props) => {
    ...
    return (
        <div className={classes.ProfileRightBox}>
            {(() =>{switch (props.show) {
                case 1:
                    return [personalParticulars, buttons];
                    
                case 2:
                    return [education, buttons];
                    
                case 3:
                    return [workExp, buttons];
                case 4: 
                    return [null];   
                case 5:
                    return [jobPreference, buttons];
                    
                case 6:
                    return [awards, buttons];
                    
                case 7:
                    return [certifications, buttons];
                    
                case 8:
                    return [projects, buttons];
